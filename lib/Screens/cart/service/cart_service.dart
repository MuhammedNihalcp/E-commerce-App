...
class CartService {
  ...
  Future<List<GetSingelCartProductModel>?> getSingleCart(
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        if (response.data == null) {
          ...
          final List<GetSingelCartProductModel> model = (response.data as List)
              .map((e) => GetSingelCartProductModel.fromJson(e))
              .toList();
